...
public class XtaMealySUL<S extends State, P extends Prec, O> extends XtaSUL<S, P> implements SUL<XtaProcess.Edge, O> {
    ...
    private XtaMealySUL(XtaSystem xtaSystem, XtaAnalysis<S, P> xtaAnalysis, P prec, Function<Boolean, O> outputFunction) {
        super(xtaSystem, xtaAnalysis, prec);
        this.outputFunction = outputFunction;
    }

    public static <S extends State, P extends Prec, O> XtaMealySUL<S, P, O>
    create(XtaSystem xtaSystem, XtaAnalysis<S, P> xtaAnalysis, P prec, Function<Boolean, O> outputFunction) {
        return new XtaMealySUL<>(xtaSystem, xtaAnalysis, prec, outputFunction);
    }
